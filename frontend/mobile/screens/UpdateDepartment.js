...
export default function UpdateDepartment({ navigation, route }) {  const { theme } = useTheme();  const { departmentId } = route.params;
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Update Department</Text>
        ...
        <View style={styles.buttonGroup}>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.submitBtnText}>Update Department</Text>
            )}
          </TouchableOpacity>
        </View>
      </View>
