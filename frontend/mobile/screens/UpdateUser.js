  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.secondary }]}>
      <View style={[styles.header, { backgroundColor: theme.colors.card }]}>
        <Text style={[styles.headerTitle, { color: theme.colors.primary }]}>Update User</Text>
      </View>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.formGroup}>
          ...
          <View style={styles.roleButtons}>
            {['user', 'admin'].map((r) => (
              <TouchableOpacity
                key={r}
                style={[styles.roleButton, { backgroundColor: theme.colors.background, borderColor: theme.colors.border }, role === r && { backgroundColor: theme.colors.primary, borderColor: theme.colors.primary }]}
                onPress={() => setRole(r)}
              >
                <Text style={[styles.roleButtonText, { color: theme.colors.text }, role === r && { color: '#ffffff' }]}>
        ...
        <View style={styles.buttonGroup}>
          <TouchableOpacity
            ...
            disabled={loading}
          >
            <Text style={styles.submitButtonText}>{loading ? 'Updating...' : 'Update User'}</Text>
          </TouchableOpacity>
